...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="footer-v4" aria-label={t.footer.ariaLabel}>
      ...
      <div className="container-v4 relative z-10">
        <div className="footer-v4-grid">
          ...
          <div>
            <Link href={getHref('/')} aria-label={`Bokengi Group · ${t.common.backToHome}`}>
              <img
          ...
          <div>
            ...
            <ul className="footer-v4-links">
              <li><Link href={getHref('/groupe')} className="footer-v4-link">{t.nav.group}</Link></li>
              <li><Link href={getHref('/expertises')} className="footer-v4-link">{t.nav.expertises}</Link></li>
              <li><Link href={getHref('/realisations')} className="footer-v4-link">{t.nav.projects}</Link></li>
              <li><Link href={getHref('/actualites')} className="footer-v4-link">{t.nav.news}</Link></li>
              <li><Link href={getHref('/contact')} className="footer-v4-link">{t.nav.contact}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="footer-v4-links">
              <li><Link href={getHref('/expertises/it')} className="footer-v4-link">Bokengi IT</Link></li>
              <li><Link href={getHref('/expertises/digital')} className="footer-v4-link">Bokengi Digital</Link></li>
              <li><Link href={getHref('/expertises/business')} className="footer-v4-link">Bokengi Business</Link></li>
              <li><Link href={getHref('/expertises/consulting')} className="footer-v4-link">Bokengi Consulting</Link></li>
              <li><Link href={getHref('/expertises/events')} className="footer-v4-link">Bokengi Events</Link></li>
            </ul>
          </div>
